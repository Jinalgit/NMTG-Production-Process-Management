...
(function () {
    ...
    const MANUAL_TIME_IDS_V30 = new Set([
        "oee-direct-start-time-v3",
        "oee-direct-stop-time-v3"
    ]);


    function formatManualTimeV30(
        input
    ) {
...
(function () {
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <input
                            type="text"
                            class="machine-oee-tool-corner-v1"
                            autocomplete="off"
                    ...
                    >
                        ...
                        <input
                            type="text"
                            class="machine-oee-tool-action-v1"
                            autocomplete="off"
                            placeholder="Enter Tool Action"
                        >
    ...
    function machineOeeToolFindAnchorV1() {
         ...
         * NO-JC / MACHINE LEVEL:
         *
         * Insert below the existing Save Losses
         * action area shown on the machine page.
         */
...
(function () {
    ...
    function formatV69(value) {
        ...
        /*
         * Five-digit operator shorthand:
         *
         * 90000  -> 09:00:00
         * 93000  -> 09:30:00
         * 74530  -> 07:45:30
         *
         * Six digits remain normal HHMMSS:
         *
         * 190000 -> 19:00:00
         */
        if (d.length === 5) {
    ...
    function normalizeV69(value) {
        ...
        /*
         * Pad incomplete values to HHMMSS.
         */
        d =
            d.padEnd(
                6,
    ...
    document.addEventListener(
        ...
        function(event) {
            ...
            /*
             * Existing OEE listeners continue receiving
             * the final HH:MM:SS value.
             */
            input.dispatchEvent(
                new Event(
                    "input",
